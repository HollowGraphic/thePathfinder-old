...
namespace ThePathfinder.Editor
{
    /// <summary>
    /// <para>
    ...
    /// </para>
    /// <para>Last tested version where issue occurred: Visual Studio 2019 16.7.6.</para>
    /// </summary>
    [InitializeOnLoad]
    public class DisableNewVS2019Optimizer : IActiveBuildTargetChanged
    {
        private const string disableString = " --compiler-flags=-d2ssa-cfg-jt-";
        ...
        private static bool BuildTargetUsesVS(BuildTarget target)
        {
            return
